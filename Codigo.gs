...
function insert_value(request,sheet){
  ...
  var carrera = request.parameter.carrera;
  var e1 = request.parameter.e1;
  var e2 = request.parameter.e2;
  var e3 = request.parameter.e3;
  var e4 = request.parameter.e4;
  var aula = request.parameter.aula;
  var flag=1;
  ...
  if(flag==1)
  {
    ...
    var rowData = sheet.appendRow([currentTime,code,carrera,e1,e2,e3,e4,aula]);
